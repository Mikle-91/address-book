...
#тест проверяет корректность отображения номеров телефонов на главной странице,
# сранвивая с отображением на странице создания/редактирования контакта
def test_phones_on_home_page(app):


    contact_from_home_page = app.contact.get_contact_list()[0]  # новая проверка учитывающая незапаолненные поля номеров
...
#
# def test_phones_on_contact_view_page(app):    # старая проверка телефонов, если все поля телефонов заполнены
